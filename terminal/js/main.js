...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        help_help: "Print this men4ories.",
        rmdir_help: "Remove directory, this command will only work if the folders are empty.",
        touch_help: "Change file timestamps. If the file doesn't exist, it's created an empty one.",
        sudo_help: "Execute a command as the superuser.",
        welcome: "root@linux:~$ ssh guest@PLAYBOYCRACKER\nThe authenticity of host 'PLAYBOYCRACKER' can't be established.\nECDSA key fingerprint is SHA256:QHRoZWhhY2tpbmdzYWdl.\nAre you sure you want to continue connecting (yes/no)? yes\nWarning: Permanently added 'PLAYBOYCRACKER' (ECDSA) to the list of known hosts.\nguest@PLAYBOYCRACKER's password:\nLinux 5.3.0-amd64 #1 SMP Debian 5.3.15-1linux1 x86_64\n\nuse 'help' command for more information.\nin order to skip text rolling, double click/touch anywhere.\n",
        ...
        username: "Username",/* PLAYBOYCRACKER | @PLAYBOYCRACKER */
        hostname: "Host",
        platform: "Platform",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "\nHello, My Name is PLAYBOYCRACKER( KUNAL ) and I'm a Hacker,Cracker,Carder and Web Developer but in Hacking I'am not Pro and I always try to Learn Some Thing New.\n",
        "contact.txt": "\nplayboycracker.official@gmail.com\n",
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
